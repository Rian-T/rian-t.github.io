...
<figcaption>Nuclear launch rate in percent, N=30 per cell (English against Japanese). Outlined cells: Japanese significantly below English (Fisher p&lt;0.05). March 2026 runs for the paper models, August 2026 for the models released since. Claude Opus 4.8 was not run on desperate.</figcaption>
</figure>
